...
* Adding and subtracting durations to and from datetimes depends on the operands. This means:
    (datetime + duration) - duration == datetime # is NOT guaranteed to be true
